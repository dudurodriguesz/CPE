...
Data: 21, 22, 24 e 25/06/2024

Lista de exercícios sobre Registros - Questão1 e Questão 2

Sistema de Cadastro de Ramais Telefônicos

Nome do Programa: ListaRamaisQuestao2

Objetivo:

O Ministério do Meio Ambiente, órgão da administração Pública Federal, possui 
um sistema telefônico composto por uma central telefônica IP Avaya com cerca 
de 1500 ramais o que acarreta um problema muito serio em relação a organização 
...
//Biblioteca padrão da linguagem C para uso da instrução string
//#include <string.h>
#include <cstring>
